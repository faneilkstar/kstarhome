"""Architecture V2: Départements + Catégories UE

Revision ID: 328a9e5fcd6d
Revises: 
Create Date: 2026-02-18 13:26:12.388034
...
def upgrade():
    ...
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.Column('date_creation', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['chef_id'], ['enseignants.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('type_diplome', sa.String(length=20), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.Column('date_creation', sa.DateTime(), nullable=True),
    ...
    sa.Column('est_ouverte_a_tous', sa.Boolean(), nullable=True),
    sa.Column('ue_parent_id', sa.Integer(), nullable=True),
    sa.Column('type_affectation', sa.String(length=20), nullable=True),
    sa.Column('classe_id', sa.Integer(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.Column('date_creation', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['classe_id'], ['classes.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['departement_id'], ['departements.id'], ),
    sa.ForeignKeyConstraint(['ue_parent_id'], ['ues.id'], ),
    sa.PrimaryKeyConstraint('id'),
